...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.10.05" ], [ "HomalgToCAS", ">= 2011.10.05" ], [ "RingsForHomalg", ">= 2011.10.05" ], [ "GradedRingForHomalg", ">= 2011.10.05" ], [ "Modules", ">= 2011.10.05" ], [ "homalg", ">= 2011.10.05" ], [ "GAPDoc", ">= 1.0" ] ],
