...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "HomalgToCAS", ">= 2010.09.28" ], [ "RingsForHomalg", ">= 2011.02.23" ], [ "GradedRingForHomalg", ">= 2011.01.04" ], [ "Modules", ">= 2011.03.18" ], [ "homalg", ">= 2011.03.05" ], [ "MatricesForHomalg", ">= 2011.02.23" ] ],
