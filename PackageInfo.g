...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "HomalgToCAS", ">= 2010.09.28" ], [ "RingsForHomalg", ">= 2010.02.29" ], [ "GradedRingForHomalg", ">= 2010.09.28" ], [ "Modules", ">= 2010.09.25" ] , [ "MatricesForHomalg", ">= 2010.09.28" ] ],
