...
# 
ArchiveURL := Concatenation( "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/HomalgToCAS/HomalgToCAS-", ~.Version ),
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "IO", ">= 2.3" ], [ "MatricesForHomalg", ">= 2011.06.28.16:00" ], [ "GAPDoc", ">= 1.0" ] ],
