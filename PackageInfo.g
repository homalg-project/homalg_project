...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.09.12" ], [ "HomalgToCAS", ">= 2011.09.04" ], [ "RingsForHomalg", ">= 2011.09.12" ], [ "GradedRingForHomalg", ">= 2011.09.12" ], [ "Modules", ">= 2011.09.24" ], [ "homalg", ">= 2011.09.21" ], [ "GAPDoc", ">= 1.0" ] ],
