...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "HomalgToCAS", ">= 2011.04.13" ], [ "RingsForHomalg", ">= 2011.04.13" ], [ "GradedRingForHomalg", ">= 2011.04.13" ], [ "Modules", ">= 2011.04.10" ], [ "homalg", ">= 2011.04.03" ], [ "MatricesForHomalg", ">= 2011.02.23" ] ],
