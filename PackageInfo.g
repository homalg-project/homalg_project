...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.05.17" ], [ "HomalgToCAS", ">= 2011.04.25" ], [ "RingsForHomalg", ">= 2011.04.25" ], [ "GradedRingForHomalg", ">= 2011.05.05" ], [ "Modules", ">= 2011.06.08" ], [ "homalg", ">= 2011.06.08" ], [ "GAPDoc", ">= 1.0" ] ],
