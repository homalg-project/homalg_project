...
# 
ArchiveURL := "http://wwwb.math.rwth-aachen.de/~barakat/LocalizeRingForHomalg",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["GAPDoc", ">= 1.0"], ["homalg", ">= 2009.09.28"]],
...
BannerString := Concatenation( 
  "----------------------------------------------------------------\n",
  "Loading  LocalizeRingForHomalg ", ~.Version, "\n",
...
Keywords := ["homological", "ext", "tor", "local"]
