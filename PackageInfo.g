...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.09.01" ], [ "HomalgToCAS", ">= 2011.06.29" ], [ "RingsForHomalg", ">= 2011.06.29" ], [ "GradedRingForHomalg", ">= 2011.08.14" ], [ "Modules", ">= 2011.09.03" ], [ "homalg", ">= 2011.08.21" ], [ "GAPDoc", ">= 1.0" ] ],
