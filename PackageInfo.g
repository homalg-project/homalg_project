...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.07.01" ], [ "HomalgToCAS", ">= 2011.06.29" ], [ "RingsForHomalg", ">= 2011.06.29" ], [ "GradedRingForHomalg", ">= 2011.07.10" ], [ "Modules", ">= 2011.06.29" ], [ "homalg", ">= 2011.07.28" ], [ "GAPDoc", ">= 1.0" ] ],
