...
Version := Maximum( [ ##To prevent merge conflicts
  "2011.04.12", ## Markus' version
  "2011.04.12:22:00", ## Mohamed's version
] ),
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "HomalgToCAS", ">= 2010.09.28" ], [ "RingsForHomalg", ">= 2011.02.23" ], [ "GradedRingForHomalg", ">= 2011.03.31" ], [ "Modules", ">= 2011.04.10" ], [ "homalg", ">= 2011.04.03" ], [ "MatricesForHomalg", ">= 2011.02.23" ] ],
