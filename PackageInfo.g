...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2010.09.28" ], [ "HomalgToCAS", ">= 2010.09.28" ], [ "RingsForHomalg", ">= 2010.09.25" ], [ "Modules", ">= 2010.09.24" ] ],
  # without these the package will issue a warning while loading
  # SuggestedOtherPackages := [],
  SuggestedOtherPackages := [ [ "GAPDoc", ">= 1.1" ], [ "homalg", ">= 2010.11.19.23:00" ] ],
