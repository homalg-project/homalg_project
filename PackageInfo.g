#############################################################################
##  
##  PackageInfo.g for the package `SCO'           Simon Goertzen
##
...
# 
ArchiveURL := Concatenation( "http://wwwb.math.rwth-aachen.de/goertzen/SCO/SCO-", ~.Version ),
...
#
README_URL := 
  "http://wwwb.math.rwth-aachen.de/goertzen/SCO/README.SCO",
PackageInfoURL := 
  "http://wwwb.math.rwth-aachen.de/goertzen/SCO/PackageInfo.g",
...
#
PackageWWWHome := "http://homalg.math.rwth-aachen.de/index.php/extensions/sco",
AbstractHTML := 
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "Modules", ">= 2010.08.17" ], [ "GAPDoc", ">= 1.0" ] ],
