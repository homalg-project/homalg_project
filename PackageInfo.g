...
# 
ArchiveURL := "http://wwwb.math.rwth-aachen.de/~simon/gap/SCO",
...
PackageDoc := rec(
  ...
  LongTitle := "SCO - Internal and External Rings for the GAP Package homalg",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["GAPDoc", ">= 1.0"],["RingsForHomalg", ">= 2008.04.12"]],
