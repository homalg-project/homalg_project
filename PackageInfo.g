...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.09.04" ], [ "HomalgToCAS", ">= 2011.09.04" ], [ "RingsForHomalg", ">= 2011.09.04" ], [ "GradedRingForHomalg", ">= 2011.09.04" ], [ "Modules", ">= 2011.09.06" ], [ "homalg", ">= 2011.08.21" ], [ "GAPDoc", ">= 1.0" ] ],
