...
Version := Maximum( [ ##To prevent merge conflicts
  "2010.11.26", ## Markus' version
  "2010.11.30", ## Mohamed's version
] ),
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2010.10.10" ], [ "HomalgToCAS", ">= 2010.11.30" ], [ "RingsForHomalg", ">= 2010.11.30" ] ],
