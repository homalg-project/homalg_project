...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.06.29" ], [ "HomalgToCAS", ">= 2011.06.29" ], [ "RingsForHomalg", ">= 2011.06.29" ], [ "GradedRingForHomalg", ">= 2011.06.29" ], [ "Modules", ">= 2011.06.29" ], [ "homalg", ">= 2011.06.20.17:00" ], [ "GAPDoc", ">= 1.0" ] ],
