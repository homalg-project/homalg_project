...
# 
ArchiveURL := "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/Sheaves/Sheaves",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["GAPDoc", ">= 1.0"], ["homalg", ">= 2010.03.02"], ["RingsForHomalg", ">= 2010.02.17"]],
