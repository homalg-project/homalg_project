#############################################################################
##  
##  PackageInfo.g for the package `GaussForHomalg'           Simon Goertzen
##
...
# 
ArchiveURL := Concatenation( "http://wwwb.math.rwth-aachen.de/goertzen/GaussForHomalg/GaussForHomalg-", ~.Version ),
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "Gauss", ">= 2009.10.07" ], [ "MatricesForHomalg", ">= 2011.06.28.16:00" ], [ "GAPDoc", ">= 1.0" ] ],
