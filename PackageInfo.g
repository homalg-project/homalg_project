...
# 
ArchiveURL := Concatenation( "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/IO_ForHomalg/IO_ForHomalg-", ~.Version ),
...
Dependencies := rec(
  ...
  NeededOtherPackages := [["GAPDoc", ">= 1.0"], ["IO", ">= 2.3"], ["HomalgToCAS", ">= 2009.06.18"]],
