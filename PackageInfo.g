...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "HomalgToCAS", ">= 2010.09.28" ], [ "RingsForHomalg", ">= 2011.02.23" ], [ "GradedRingForHomalg", ">= 2011.03.31" ], [ "Modules", ">= 2011.04.09" ], [ "homalg", ">= 2011.04.03" ], [ "MatricesForHomalg", ">= 2011.02.23" ] ],
