...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "MatricesForHomalg", ">= 2011.08.05" ], [ "HomalgToCAS", ">= 2011.06.29" ], [ "RingsForHomalg", ">= 2011.06.29" ], [ "GradedRingForHomalg", ">= 2011.07.10" ], [ "Modules", ">= 2011.08.12" ], [ "homalg", ">= 2011.08.08" ], [ "GAPDoc", ">= 1.0" ] ],
