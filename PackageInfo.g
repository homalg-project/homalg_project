...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "HomalgToCAS", ">= 2010.09.28" ], [ "RingsForHomalg", ">= 2010.02.29" ], [ "GradedRingForHomalg", ">= 2010.10.08" ], [ "Modules", ">= 2011.01.02" ], [ "homalg", ">= 2011.01.02" ], [ "MatricesForHomalg", ">= 2010.10.10" ] ],
