...
##  -------------------------
##  gap> T := RHom( C, N );
##  <An exact cotriangle containing 3 morphisms of right cocomplexes at degrees [ 0, 1, 2, 0 ]>
##  gap> ByASmallerPresentation( T );
##  <A non-zero exact cotriangle containing 3 morphisms of right cocomplexes at degrees [ 0, 1, 2, 0 ]>
...
##  true
##  gap> L;
##  <An exact cosequence containing 5 morphisms of right modules at degrees [ 0 .. 5 ]>
##  ]]></Example>
##  <#/GAPDoc>
