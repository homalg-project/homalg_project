##  <#GAPDoc Label="Schenk-8.3">
##  <Subsection Label="Schenk-8.3">
##  <Heading>Schenk-8.3</Heading>
##  <Example><![CDATA[
...
##  gap> J := RightPresentationWithWeights( jmat );
...
J := RightPresentationWithWeights( jmat );
