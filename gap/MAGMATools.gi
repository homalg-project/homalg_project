        ...
        rec(
               ...
               DegreeMultivariatePolynomial :=
                 function( r, R )
                   ...
                   return Int( homalgSendBlocking( [ "Degree(", R, "!", r, ")" ], "need_output", HOMALG_IO.Pictograms.DegreeMultivariatePolynomial ) );
               ...
               CopyMatrix :=
                 function( C, R )
                   ...
                   return HomalgMatrix( homalgSendBlocking( [ "Matrix(", R, C, ")" ], HOMALG_IO.Pictograms.CopyMatrix ), NrRows( C ), NrColumns( C ), R );
