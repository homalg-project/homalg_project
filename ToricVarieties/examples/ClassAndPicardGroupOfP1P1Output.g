...
gap> P1P1 := P1*P1;
<A projective toric variety which 
is a product of 2 toric varieties>
gap> ClassGroup( H5 );
<A non-torsion left module presented by
2 relations for 4 generators>
gap> PicardGroup( H5 );
<A non-torsion left submodule
given by 4 generators>
gap> ClassGroup( P1P1 );
<A non-torsion left module presented 
by 2 relations for 4 generators>
gap> H5;
