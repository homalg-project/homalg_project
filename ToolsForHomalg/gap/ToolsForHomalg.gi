...
# which is a subrepresentation of the representation IsStructureObjectOrFinitelyPresentedObjectRep and IsHomalgSemiringOrModule:
DeclareRepresentation( "IsHomalgSemiringOrFinitelyPresentedModuleRep",
